...
class ResultReceivedViewController: UIViewController {
    ...
    func binding() {
        ...
        output.receivedSesac.bind(to: mainView.sesacTableView.rx.items(cellIdentifier: ProfileCardTableViewCell.identifier, cellType: ProfileCardTableViewCell.self)) { (row, element, cell) in
            print("??")
